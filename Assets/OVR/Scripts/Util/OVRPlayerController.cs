...
public class OVRPlayerController : MonoBehaviour
{
	...
	//ZZ: add lookCamera for raycasting
	public GameObject lookCamera;

	//ZZ: control walkaround when grounded, control falling acceleration when falling;
	public bool isWalkAround = false;
	public bool isFinal = false;
	public bool isBreathAcceleration = false;
	public bool isBreathDeceleration = false;

	//ZZ:
	public float moveDownScale = 0.05f; //controls how fast controller moves down normally
	public float moveForwardScale = 0.03f; //controls how fast controller moves forward when looking
	public float acelScale = -0.00005f; //controls how fast accelerate down when breathing, should always be negative, and very small.
	public float recoverScale = 0.02f; //should always be positive


	//ZZ: intermediate acceleration/decelration speed. 
	Vector3 tempPos;
	Vector3 tempVel = new Vector3 (0, -0.01f, 0);
	Vector3 tempAcel = new Vector3(0, 0, 0);
...
//		Vector3 moveDirection = Vector3.zero;
		...
		//ZZ: overwrite intitial move direction to downward
		Vector3 moveDirection = Vector3.down * moveDownScale * Time.deltaTime;
